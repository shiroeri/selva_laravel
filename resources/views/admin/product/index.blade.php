    ...
    <div class="max-w-7xl mx-auto py-10 px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white shadow-xl rounded-xl p-6 mb-8">
            <form action="{{ route('admin.product.index') }}" method="GET">
                ...
                {{-- 並べ替え条件を隠しフィールドとして含める (検索フォームからの遷移時にソート状態を維持するため) --}}
                    ...
                    <thead class="bg-gray-50">
                        <tr>
                            ...
                            <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider w-1/6">
                                ...
                                @endphp
                                <a href="{{ route('admin.product.index', array_merge($searchParams, ['sort_column' => 'id', 'sort_direction' => $newDirection, 'page' => 1])) }}"
                            ...
                            <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider w-1/6">
                                ...
                                @endphp
                                <a href="{{ route('admin.product.index', array_merge($searchParams, ['sort_column' => 'created_at', 'sort_direction' => $newDirection, 'page' => 1])) }}"
                                   class="header-link flex items-center">
                                    登録日時
